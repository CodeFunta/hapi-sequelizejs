...
async function configure(options) {
    ...
    if (options.models) {
        ...
        let models = !options.useClassModels? 
                            await Models.load(files, options.sequelize.import.bind(options.sequelize)):
                            await Models.loadModelsClass(files, options.sequelize);
